...
namespace Millionlights.Models
{
   public class Constants
    {
        static readonly string mainUrl = System.Configuration.ConfigurationManager.AppSettings["ActualUrl"].ToString();
        static readonly string newPartnerName = System.Configuration.ConfigurationManager.AppSettings["SenderName"].ToString();
        static readonly string emailId = System.Configuration.ConfigurationManager.AppSettings["EmailId"].ToString();
       ...
       public static readonly string UserRegMsgNotification = "Your registration with" + newPartnerName + "is successful. Your login id {0} and Password is {1}";
       public static readonly string StudentRegMsgNotification = "Your registration with " +newPartnerName + " is successful. Your login id {0}";
       public static readonly string ExtUserRegMsgNotification = "Your registration with " +newPartnerName + " is successful. Your login id {0}";
       public const string ForgotPwdSubNotification = "Your password reset request has been sent to you successfully.";
       public static readonly string ForgotPwdMsgNotification = "Please note, a link to reset your password has been sent to you.In case of any issues, contact " + newPartnerName + " Support at" + emailId;
       public const string ResetPwdSubNotification = "Your Password reset successfully";
       public static readonly string ResetPwdMsgNotification = "Please note, your password has been reset as requested by you.In case of any issues, contact " + newPartnerName + " Support at" + emailId;
       ...
       public static readonly string UserRegistrationSuccessMsg = "Your " + newPartnerName + " registration is successful. Loginid is {0} and Password is {1}";
       public static readonly string StudentRegistrationSuccessMsg = "Your " + newPartnerName + " registration is successful. Loginid is {0}";
       public static readonly string UserPasswordChange = "Your " + newPartnerName + " password has been changed successfully. Your LoginId is {0}";
       ...
       public static readonly string OrderFailSMSMsg = "Your order {0} on " + newPartnerName + " has failed.";
       public static readonly string OrderSuccessSMSMsg = "Your order {0} on " + newPartnerName + " is successful";
       public static readonly string ContactUsSMSMsg = "Thank you for contacting " + newPartnerName + ". We will get back to you soon.";
       ...
       public static readonly string ResetPasswordLink = mainUrl + "/Account/ResetMyPassword?verificationId={0}";
