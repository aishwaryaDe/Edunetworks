...
namespace Millionlights.EmailService
{
    ...
    {
        string mainUrl = System.Configuration.ConfigurationManager.AppSettings["ActualUrl"].ToString();
        string logoLink = System.Configuration.ConfigurationManager.AppSettings["MainLogo"].ToString(); 
        string emailId = System.Configuration.ConfigurationManager.AppSettings["EmailId"].ToString();
        string emailTitle = System.Configuration.ConfigurationManager.AppSettings["EmailTitle"].ToString();
        ...
        public void SendRegistrationCompleteEmail(string fromName, string fromEmail, string telephone, string email, string subject, string registTemplate, string name, string loginId, string password)
        {
            ...
            //Uri currentUrl = new Uri(HttpContext.current.Request.Url, "../coursat/images/edulogo.jpg");
             registrationMail = registrationMail.Replace("[MainLogo]", mainUrl + logoLink);
            //envolop
            ...
            registrationMail = registrationMail.Replace("[EmailTwitter]", emailTwitter);

            registrationMail = registrationMail.Replace("[EmailFacebook]", emailFacebook);

            registrationMail = registrationMail.Replace("[EmailId]", emailId);

            registrationMail = registrationMail.Replace("[EmailTitle]", emailTitle);

            registrationMail = registrationMail.Replace("[NewPartnerName]", newPartnerName);
          ...
          string name, string logo, string loginId, string copCode,decimal discountPrice,string courseWithPrice,int allowedCourses,string partnerType,string partnerName,DateTime ValidFrom,DateTime validTo)
        {
         ...
         //   registrationMail = registrationMail.Replace("[Base64Image]", "../Content/assets/img/slider/Logo.png");
            Uri currentUrl = new Uri(HttpContext.Current.Request.Url, "../Content/assets/img/slider/Logo.png");
            registrationMail = registrationMail.Replace("[MainLogo]", currentUrl.AbsoluteUri);
