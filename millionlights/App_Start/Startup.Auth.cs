...
namespace Millionlights
{
    ...
    public partial class Startup
    {
        ...
        private static void FacebookAuthOptions(IAppBuilder app)
        {
            ...
            string fbAppId = System.Configuration.ConfigurationManager.AppSettings["FbAppId"].ToString();
            string fbAppSecret = System.Configuration.ConfigurationManager.AppSettings["FbAppSecret"].ToString();

            x.Scope.Add("email");
            x.AppId = fbAppId;
            x.AppSecret = fbAppSecret;
        ...
        private static void GoogleAuthOptions(IAppBuilder app)
        {
            ...
            string GoogleClientSecret = System.Configuration.ConfigurationManager.AppSettings["GoogleClientSecret"].ToString();

            y.Scope.Add("email");
            y.ClientId = googleClientId;
            y.ClientSecret = GoogleClientSecret;
        ...
        private static void LinkedInAuthOptions(IAppBuilder app)
        {
            ...
            string linkdinClientId = System.Configuration.ConfigurationManager.AppSettings["LinkdinClientId"].ToString();
            string linkdinClientSecret = System.Configuration.ConfigurationManager.AppSettings["LinkdinClientSecret"].ToString();

            l.ClientId = linkdinClientId;
            l.ClientSecret = linkdinClientSecret;
