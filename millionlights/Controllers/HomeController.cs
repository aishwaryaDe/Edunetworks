    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult GetCourseEmailext(string courseId, string courseName)
        {
            ...
            if (isCourseEnrolled.Count() > 0)
            {
                emailText = "Hello, I have enrolled for the online course " + courseName +
                    " , from" + newPartnerName +". This course might interest you too. Please have a look on " + poratlEmail;
            }
            else
            {
                emailText = "Hello, I came across the online course " + courseName +
                    " , from" + newPartnerName + ". This course might interest you. Please have a look on " + poratlEmail;
            }
        ...
        public List<ShortCourse> GetAllActiveCourses()
        {
            var courses = (from course in db.Courses
                           ...
                           select new ShortCourse
                           {
                               ...
                               EmailCourseName = "Hello, I have came across the online course " + course.CourseName.Trim() + " , from " + newPartnerName + ". This course might interest you too. Please have a look on " + poratlEmail
                           }).ToList();
            return courses;
        }
        ...
        public ActionResult UserFeedbackEmail()
        {
            ...
            try
            {
                ...
                string subject = "Thank you for submitting the feedback to " + newPartnerName + ", we'll get back to you soon!";
                string txtMessage = "Dear " + name + "," + "<br/> " + " We have submitted your feedback and will get back to you soon, Thank you!" + "<br/> " + "Warm Regards," + "<br/> " + newPartnerName + " Team" + "<br/> " + "Telephone:+91 9890122592" + "<br/> " + "Email:" + emailId;
                string senderEmail = ConfigurationManager.AppSettings["SenderEmail"];
