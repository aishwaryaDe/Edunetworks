...
namespace Millionlights.Controllers
{
    public class OrderController : Controller
    {
        ...
        {
            string emailtemp = System.Configuration.ConfigurationManager.AppSettings["ActualUrl"].ToString();
            if (Session["UserID"] == null)
            {
                return RedirectToAction("Login", "Account");
            }
            ...
            foreach (var course in courses)
            {
                if (course != "")
                {
                    ...
                    string viewCourse = "<span style='float:right'><a href=" + crs.EDXCourseLink + " target='_blank'><img src='"+emailtemp+"/coursat/images/finalstart.png'></img></a></span><br/><hr>";
